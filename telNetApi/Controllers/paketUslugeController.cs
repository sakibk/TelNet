...
{
    public class paketUslugeController : baseApiController<paketUsluge>
    {
        public paketUslugeController(baseInterface<paketUsluge> depo) : base(depo){ }
        ...
        public HttpResponseMessage Post(paketUslugeModel dm)
        {
            try
            {
        ...
        public HttpResponseMessage Delete(int id)
        {
            try
            {
                paketUsluge entity = tnDepo.get(id);
                if (entity == null)
                    return Request.CreateErrorResponse(HttpStatusCode.BadRequest, "No data");
