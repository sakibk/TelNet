...
{
    public class ponudaProizvodaController : baseApiController<ponudaProizvoda>
    {
        public ponudaProizvodaController(baseInterface<telNet.Models.ponudaProizvoda> depo) : base(depo){ }
        ...
        public HttpResponseMessage Post(ponudaProizvodaModel dm)
        {
            try
            {
        ...
        public HttpResponseMessage Delete(int id)
        {
            try
            {
                ponudaProizvoda entity = tnDepo.get(id);
                if (entity == null)
                    return Request.CreateErrorResponse(HttpStatusCode.BadRequest, "No data");
