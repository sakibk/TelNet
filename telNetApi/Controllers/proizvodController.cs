...
{
    public class proizvodController : baseApiController<proizvod>
    {
        public proizvodController(baseInterface<telNet.Models.proizvod> depo) : base(depo){ }
        ...
        public HttpResponseMessage Post(proizvodModel dm)
        {
            try
            {
