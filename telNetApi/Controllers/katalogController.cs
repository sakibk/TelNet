...
{
    public class katalogController : baseApiController<telNet.Models.katalog>
    {
        public katalogController(baseInterface<telNet.Models.katalog> depo) : base(depo){ }
        ...
        public HttpResponseMessage Post(katalogModel dm)
        {
            try
            {
