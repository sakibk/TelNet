...
{
    public class dobavljaciController : baseApiController<telNet.Models.dobavljac>
    {
        public dobavljaciController(baseInterface<telNet.Models.dobavljac> depo) : base(depo){        }
        ...
        public HttpResponseMessage Post(dobavljacModel dm)
        {
            try
            {
        ...
        public HttpResponseMessage Delete(int id)
        {
            try
            {
                dobavljac entity = tnDepo.get(id);
                if (entity == null)
                    return Request.CreateErrorResponse(HttpStatusCode.BadRequest, "No data");
