...
{
    public class osobeController : baseApiController<osobe>
    {
        public osobeController(baseInterface<telNet.Models.osobe> depo) : base(depo){ }
        ...
        public HttpResponseMessage Post(osobeModel dm)
        {
            try
            {
