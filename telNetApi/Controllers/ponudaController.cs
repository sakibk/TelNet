...
{
    public class ponudaController : baseApiController<ponuda>
    {
        public ponudaController(baseInterface<telNet.Models.ponuda> depo) : base(depo){ }
        ...
        public HttpResponseMessage Post(ponudaModel dm)
        {
            try
            {
