...
{
    public class paketController : baseApiController<paket>
    {
        public paketController(baseInterface<telNet.Models.paket> depo) : base(depo){ }
        ...
        public HttpResponseMessage Post(paketModel dm)
        {
            try
            {
