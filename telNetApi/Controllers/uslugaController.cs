...
{
    public class uslugaController : baseApiController<usluga>
    {
        public uslugaController(baseInterface<telNet.Models.usluga> depo) : base(depo){ }
        ...
        public HttpResponseMessage Post(uslugaModel dm)
        {
            try
            {
