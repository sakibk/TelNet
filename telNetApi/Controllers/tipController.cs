...
{
    public class tipController : baseApiController<tip>
    {
        public tipController(baseInterface<telNet.Models.tip> depo) : base(depo){ }
        ...
        public HttpResponseMessage Post(tipModel dm)
        {
            try
            {
